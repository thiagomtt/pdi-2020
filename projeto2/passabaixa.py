...
#
# Implementação da filtragem passa-baixa utilizando o filtro Butterworth
#
# Grupo:
...
def low_pass_butterwoorth_filter(img, d0, n):

	num_rows, num_cols = img.shape
	freq_r, freq_c = generate_frequencies(num_rows, num_cols)

	low_pass_butterwoorth_filter = np.zeros([num_rows, num_cols])
